...
default['haproxy']['source']['version'] = '1.5-dev23'
default['haproxy']['source']['url'] = 'http://haproxy.1wt.eu/download/1.5/src/devel/haproxy-1.5-dev23.tar.gz'
default['haproxy']['source']['checksum'] = '2824cf09a05f87debf5bd8ea4b6eec22'
